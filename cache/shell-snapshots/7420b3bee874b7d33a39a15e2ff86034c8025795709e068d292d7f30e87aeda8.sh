...
export PATH='/usr/local/cuda-13.0/bin:/root/miniconda3/bin:/root/miniconda3/condabin:/usr/local/bin:/usr/bin:/bin:/usr/local/cuda-13.0/bin:/root/.vscode-server/data/User/globalStorage/github.copilot-chat/debugCommand:/root/.vscode-server/data/User/globalStorage/github.copilot-chat/copilotCli:/root/.vscode-server/cli/servers/Stable-125df4672b8a6a34975303c6b0baa124e560a4f7/server/bin/remote-cli:/root/miniconda3/bin:/root/miniconda3/condabin:/usr/local/sbin:/usr/sbin:/sbin:/usr/games:/usr/local/games:/snap/bin'